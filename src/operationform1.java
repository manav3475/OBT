...
/**
 * Servlet implementation class operationform1
 */
@WebServlet("/operationform1")
public class operationform1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public operationform1() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rs =  ps.executeQuery();
			rs.next();
			pw.print("<form action='operationwithdatabasecus' method='post'>"
					+"<center>"
					+"<table>"
					+"<tr>"
					+		"<td>Name</td>"
